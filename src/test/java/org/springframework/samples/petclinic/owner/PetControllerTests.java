...
class PetControllerTests {
	...
	class ProcessUpdateFormHasErrors {
		...
		void testProcessUpdateFormWithDuplicateName() throws Exception {
			// Rename pet 2 (doggy) to "petty" (name of pet 1 with a different id)
			// This should trigger the duplicate name rejection
			mockMvc
	...
	@Test
	void testProcessUpdateFormKeepsSameNameSuccess() throws Exception {
		// Updating pet 1 but keeping the same name "petty" should succeed
		mockMvc
